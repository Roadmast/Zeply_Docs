...
```bash cURL
curl -X GET "https://api.pingr.ai/api/v1/quick-replies?limit=50&page=1" \
...
const response = await fetch("https://api.pingr.ai/api/v1/quick-replies?limit=50&page=1", {
  method: "GET",
  headers: {
    "Authorization": "Bearer <token>"
  }
...
```json 200 OK
{
  ...
  "items": [
    ...
    },
    {
      ...
      "shortcut": "/greeting",
      "content": "Hi there! Thanks for reaching out to Pingr AI. How can I assist you today?",
