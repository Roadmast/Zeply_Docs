...
description: "System limits, payload constraints, and concurrency quotas across Pingr AI"
---

# Limits and Quotas

To ensure ultra-low latency (sub-500ms voice turn-around) and protect against infrastructure denial-of-service, Pingr AI applies the following payload, concurrency, and operational limits.
...
1. Visit the **Billing & Plan** tab in your Pingr AI Console.
2. Click **Request Quota Increase** or reach out directly to your account manager at [support@pingr.ai](mailto:support@pingr.ai).
