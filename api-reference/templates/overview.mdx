...
description: "Design, synchronize, and manage Meta-approved WhatsApp Business message templates in Pingr AI"
---
...
Pingr AI offers a two-tier template management system:
...
<CardGroup cols={2}>
  ...
  <Card title="Bi-Directional Synchronization" icon="rotate">
    Sync existing approved templates from your WhatsApp Business Account directly into Pingr AI's database.
  </Card>
