...
```bash cURL
curl -X GET "https://api.pingr.ai/api/v1/call-logs/7b8d8b9e-63f5-46b6-9bb2-15f18731b819" \
...
url = "https://api.pingr.ai/api/v1/call-logs/7b8d8b9e-63f5-46b6-9bb2-15f18731b819"
headers = {
    "Authorization": "Bearer <token>"
}
...
const response = await fetch("https://api.pingr.ai/api/v1/call-logs/7b8d8b9e-63f5-46b6-9bb2-15f18731b819", {
  method: "GET",
  headers: {
    "Authorization": "Bearer <token>"
  }
