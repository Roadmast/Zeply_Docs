...
url = "https://api.pingr.ai/api/v1/knowledge-base/upload"
...
const response = await fetch("https://api.pingr.ai/api/v1/knowledge-base/upload", {
  method: "POST",
  headers: {
    "Authorization": "Bearer <token>"
  },
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://api.pingr.ai/api/v1/knowledge-base/upload"))
