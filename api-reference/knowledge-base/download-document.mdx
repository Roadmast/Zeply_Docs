...
```bash cURL
curl -X GET "https://api.pingr.ai/api/v1/knowledge-base/c5d1e2f3-4a5b-6c7d-8e9f-0123456789ab/download" \
...
url = "https://api.pingr.ai/api/v1/knowledge-base/c5d1e2f3-4a5b-6c7d-8e9f-0123456789ab/download"
...
const response = await fetch(
  "https://api.pingr.ai/api/v1/knowledge-base/c5d1e2f3-4a5b-6c7d-8e9f-0123456789ab/download",
  {
    method: "GET",
    headers: {
      "Authorization": "Bearer <token>"
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://api.pingr.ai/api/v1/knowledge-base/c5d1e2f3-4a5b-6c7d-8e9f-0123456789ab/download"))
