...
```bash cURL
curl -X POST "https://api.pingr.ai/api/v1/contacts/bulk-upload" \
...
url = "https://api.pingr.ai/api/v1/contacts/bulk-upload"
...
const response = await fetch("https://api.pingr.ai/api/v1/contacts/bulk-upload", {
  method: "POST",
  headers: {
    "Authorization": "Bearer <token>"
  },
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://api.pingr.ai/api/v1/contacts/bulk-upload"))
