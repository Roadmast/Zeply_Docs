...
description: "Manage customer profiles, segmentation tags, custom metadata, and bulk ingestion in Pingr AI"
---
...
Each contact in Pingr AI is scoped to your organization and contains:
