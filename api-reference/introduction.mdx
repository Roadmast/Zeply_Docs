...
icon: "code"
description: "Overview of the Pingr AI REST API architecture and developer platform"
---

# Pingr AI API Reference

Welcome to the Pingr AI REST API reference. The Pingr AI API enables developers to programmatically create and configure conversational AI voice agents, dispatch outbound calling campaigns, manage multi-channel messaging (WhatsApp & SMS), stream real-time WebRTC audio, and configure webhook delivery.
...
The Pingr AI API is served over secure HTTPS. All requests must use TLS 1.3 or higher.

| Environment | Base URL | Usage |
| :--- | :--- | :--- |
| **Production** | `https://api.pingr.ai/api/v1` | Live production workloads |
| **Staging / Sandbox** | `https://sandbox-api.pingr.ai/api/v1` | Pre-production testing |
| **Local Development** | `http://localhost:8000/api/v1` | Self-hosted backend testing |

```bash
# Health check endpoint
curl -X GET https://api.pingr.ai/api/v1/health \
  -H "Authorization: Bearer pingr_sk_live_your_api_key"
```
