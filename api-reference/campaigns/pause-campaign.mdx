...
api: "POST /api/v1/campaigns/{campaign_id}/pause"
description: "Halt an active sending or scheduled campaign dispatch"
---
...
```bash cURL
curl -X POST "https://api.pingr.ai/api/v1/campaigns/e4a2e584-3672-4d69-b541-6e9f1a238491/pause" \
...
url = "https://api.pingr.ai/api/v1/campaigns/e4a2e584-3672-4d69-b541-6e9f1a238491/pause"
...
const response = await fetch("https://api.pingr.ai/api/v1/campaigns/e4a2e584-3672-4d69-b541-6e9f1a238491/pause", {
  method: "POST",
  headers: {
    "Authorization": "Bearer <token>"
  }
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://api.pingr.ai/api/v1/campaigns/e4a2e584-3672-4d69-b541-6e9f1a238491/pause"))
