...
<ParamField body="is_active" type="boolean">
  Toggle whether Pingr AI actively dispatches webhook payloads to this endpoint (`true` or `false`).
</ParamField>
...
```bash cURL
curl -X PUT "https://api.pingr.ai/api/v1/webhooks/8f3b0e2a-71d3-4a5f-9e6b-123456789abc" \
  -H "Authorization: Bearer <token>" \
  -H "Content-Type: application/json" \
  -d '{
    "url": "https://example.com/api/webhooks/v2/pingr",
    "events": [
      "call.completed",
      "call.started",
      "ai.tool.executed"
