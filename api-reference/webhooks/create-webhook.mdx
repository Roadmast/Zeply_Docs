...
<ParamField body="url" type="string" required>
  Your server's HTTPS callback URL. Must begin with `http://` or `https://`. Example: `https://example.com/api/webhooks/pingr`.
</ParamField>
...
<ResponseField name="secret" type="string">
  HMAC SHA-256 signing secret key used to verify the `X-Pingr-Signature` header.
</ResponseField>
