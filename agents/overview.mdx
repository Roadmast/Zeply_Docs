...
description: "Core concepts of Sayvy AI voice agents, pipeline architectures, and execution flow"
---

# Voice Agents in Sayvy AI

Voice agents are the central orchestration entity in Sayvy AI. Each agent configures:
...
sequenceDiagram
    ...
    participant Agent as Sayvy Voice Agent
